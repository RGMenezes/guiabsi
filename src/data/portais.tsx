...
const academicLife: PortalsData[] = [
  {
    name: "Acadêmico",
    tag: "essencial",
...
const opportunities: PortalsData[] = [
  {
    name: "Portal de Seleções",
    tag: "essencial",
...
const virtualClassrooms: PortalsData[] = [
  {
    name: "Moodle (EAD)",
    tag: null,
